...
<section id="new-article" class="row-padding">
    <div class="col m12">
        <div class="container card-2 round white">
            <h1 class="opacity">Kercode Network</h1>
            <form action="index.php?action=newarticle" method="POST" class="no-margin" enctype="multipart/form-data">
                <textarea name="new-article-edit" id="new-article-edit" rows="1" class="w100 margin-bottom-small no-resize round"placeholder="Exprimez-vous !"></textarea>
